              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => copyToClipboard("NEXT_PUBLIC_CONTRACT_ADDRESS=0xYourContractAddress", 5)}
                  >
                    {copiedStep === 5 ? <CheckCircle className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                  </Button>
                </div>
                <code className="text-sm">NEXT_PUBLIC_CONTRACT_ADDRESS=0xYourContractAddress</code>
              </div>
